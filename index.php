                        ...
                        <div id="box_wrapper" style="left: 0px">
                            <div id="announcement2" class="content_box">
                                <div class="announcement">
                                    ...
                                    <h3 class="announcement-theme">10 февраля в 16:00 в аудитории 257 главного корпуса НГУ состоялся семинар.<br><br>
                                    ...
                                    <a href="/data/presentation/10_02/presentation_10_02.pdf" download="presentation_10_02">скачать презентацию в формате pdf</a></h3>

                                    <div class="btn-slide" ><hr/></div>

                                    <h4 id="panel"> На заседании семинара был представлен проект технологии смешанного обучения НГУ, подготовленный для программы повышения конкурентоспособности.
                                    ...
                                    <div class="note">По техническим причинам видеозапись этого семинара опубликована не будет.</div><br>
                                    <a href="#" id="ann2-to-ann1">Предыдущий семинар --></a></h4>
                                </div>
                            </div>
                            ...
                            <div id="announcement1" class="content_box">
                                <div class="announcement">
                                    ...
                                    <h4 id="panel">Предметом рассмотрения стали современные социально-сетевые сервисы и способы их построения.
                                    ...
                                    Приведены основные направления предлагаемых поисковых исследований.</h4>
                                </div>
                            </div>
                        </div>
                    </div>
